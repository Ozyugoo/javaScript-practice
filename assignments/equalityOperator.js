...
// Finally, convert numNeighbours to a number, and watch what happens now when you input 1. This happened because the loose equality did not coerse the input into a number, there we needed to convert the type to number to achieve what we want on strict equality. It is better to use strict equality and type conversion so that you will be incharge of your code and its behavior.
